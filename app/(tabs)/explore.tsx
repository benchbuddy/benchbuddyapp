...
export default function BenchListScreen() {
  return (
    ...
    >
      ...
      <ThemedText>All your bench locations will appear here once the map is connected.</ThemedText>
      <ThemedView style={styles.listPlaceholder}>
        <ThemedText type="subtitle">Bench list placeholder</ThemedText>
        <ThemedText>
          {`This tab will show nearby bench locations and details for each bench.`}
        </ThemedText>
      </ThemedView>
    </ParallaxScrollView>
  );
